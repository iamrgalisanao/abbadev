// Animated WebGL gradient (simplex-noise flow + glow + grain), adapted from the
// "Velaris" reference and recoloured to the v2 blue theme. Rendered behind the
// CTA card content. Falls back gracefully (transparent) if WebGL is unavailable,
...
// v2 blue theme palette (matches --v2-accent / accent-2 / accent-strong on a dark base).
const CTA_BG = '#070b14'
const CTA_COLORS = ['#4da3ff', '#38e0d4', '#2f7fe0', '#0a1730']
...
export default function CtaGradient({ bg = CTA_BG, colors = CTA_COLORS, speed = 1.32, grain = 0.18 }) {
  ...
  return (
    <div ref={containerRef} className="v2-cta-gradient" aria-hidden="true">
