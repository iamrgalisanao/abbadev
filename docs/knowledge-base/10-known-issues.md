...
| 4 | The v2 homepage has no working consultation form. Its CTAs go to `#contact` (a CTA card) or `/consulting-intake` (a template page with no form) | `src/v2/V2Home.jsx:364`, `contentPages['/consulting-intake']` |
